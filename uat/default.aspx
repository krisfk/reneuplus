<%@ Page Title="" Language="VB" MasterPageFile="~/uat/tc.master" %>
                ...
                <div class="col-xs-12 hidden-xs">
                    <div id="layersliderWeb" style="width: 100%">
                        ...
                        <div style="position: relative;background: #000;">
                            ...
                            <a href="#" class="video-cover-new">

                                <div class="video-detail-btn" href="javascript:void(0);">詳細介紹</div>
                            </a>
            ...
            <div class="row row-same-height">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 challenge  color_white background_gold" style="padding-top:20px;">
                    ...
                    <div class="col-sm-10 col-sm-offset-1 col-xs-12" style="font-size: 19px;padding:0 0 40px 0">
                        ...
                        通過十年的科學研究和實踐， reNeu+ 煥妍美學獨家研發了Quantum reNeurologyTM量子重啟系統，能幫助您回復身體內部平衡和進一步提升外在美，達致非凡健康。<br><br> 通過平衡互動，我們的身體機能可以整體提升，達到增強免疫力及自癒力，並進一步回復因年齡而老化的各種機能，從而回復及保持青春、美貌；並令您更聰穎。
                    </div>
